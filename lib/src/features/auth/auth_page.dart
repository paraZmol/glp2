...
class _AuthPageState extends State<AuthPage> {
  ...
  Future<void> _signInEmail() async {
    ...
    try {
      await _service.signInWithEmail(_emailController.text.trim(), _passController.text);
  ...
  Future<void> _signUpEmail() async {
    setState(() => _status = 'procesando...');
    try {
      await _service.signUpWithEmail(_emailController.text.trim(), _passController.text);
        ...
        child: Column(
          children: [
            ...
            Row(children: [
              ...
              ElevatedButton(onPressed: _signUpEmail, child: const Text('sign up')),
            ]),
